...
namespace System
{
    public static partial class StringExtensions
    {
        ...
        public static partial IEnumerable<string> SkipLast(this string[] input, int count) => Enumerable.SkipLast(input, count);

        [EditorBrowsable(EditorBrowsableState.Never)]
        public static partial IEnumerable<string> SkipLast(this string[] input) => Enumerable.SkipLast(input, 1);

        [EditorBrowsable(EditorBrowsableState.Never)]
        public static partial IEnumerable<string> SkipLast(this ICollection<string> input, int count) => Enumerable.SkipLast(input, count);
 
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static partial IEnumerable<string> SkipLast(this ICollection<string> input) => Enumerable.SkipLast(input, 1);

        [EditorBrowsable(EditorBrowsableState.Never)]
        public static partial IEnumerable<string> SkipLast(this IEnumerable<string> input) => Enumerable.SkipLast(input, 1);
